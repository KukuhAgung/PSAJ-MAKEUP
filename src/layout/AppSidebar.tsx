...
const navItems: NavItem[] = [
...

  {
    name: "Gallery",
    icon: <ListIcon />,
    subItems: [{ name: "Input Gallery", path: "/admin/gallery", pro: false }, { name: "Preview", path: "/admin/gallery-preview", pro: false }],
  },
  {
    name: "Tabel",
    icon: <TableIcon />,
    subItems: [ { name: "Daftar Booking", path: "/admin/booking", pro: false }, { name: "Riwayat Transaksi", path: "/admin/transaction-history", pro: false }, { name: "Testimoni", path: "/admin/testimoni", pro: false }],
  }
  // {
  //   name: "Pages",
  //   icon: <PageIcon />,
      ...
      >
        <Link href="/">
          {isExpanded || isHovered || isMobileOpen ? (
            <>
              <Image
                className="dark:hidden object-contain w-full"
