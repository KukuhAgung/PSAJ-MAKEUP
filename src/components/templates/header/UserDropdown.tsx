...
import { UserDropdownProps } from "./index.model";
  ...
  return (
    <div className="relative w-fit">
      <button
        ...
        className="flex w-fit items-center justify-between text-gray-700 dark:text-gray-400"
      >
        {!onUserPage ? (
          <>
            <span className="ml-3 mr-1 block text-theme-sm font-medium">
              {username || "-"}
            </span>
          ...
          <>
            <span className="mr-1 block text-theme-lg font-medium text-primary-500">
              {username || "-"}
            </span>

            <svg
              className={`stroke-primary-500 transition-transform duration-200 dark:stroke-primary-400 ${
                isOpen ? "rotate-180" : ""
              }`}
              width="18"
              height="20"
        ...
        <span className="mx-2 h-12 w-12 overflow-hidden rounded-full">
          {image === null ? (
      ...
      <Dropdown
        ...
        className="fixed right-0 z-999999 mt-[17px] flex w-[260px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark"
      >
        <div>
          ...
          {inputReview && (
            <li>
              <DropdownItem
                onItemClick={closeDropdown}
                tag="a"
                href={`/testimoni/${cleanUsername}`}
                className="group flex items-center gap-3 rounded-lg px-3 py-2 text-theme-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
              >
                <MdOutlineRateReview size={24} fill="#6B7280" />
                Testimoni
              </DropdownItem>
            </li>
          )}
