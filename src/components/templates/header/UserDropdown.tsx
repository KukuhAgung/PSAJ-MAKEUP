  ...
  return (
    <div className="w-fit relative">
      <button
        ...
        className="w-fit flex items-center justify-between text-gray-700 dark:text-gray-400"
      >
        {!onUserPage ? (
          <>
          ...
          <>
            <span className="text-theme-lg mr-1 block font-medium text-primary-500">
              Musharof
            </span>
