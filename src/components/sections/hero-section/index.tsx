                ...
                <div className="flex gap-x-4 w-fit">
                    <div className="flex items-center">
                        {Array.from({ length: 3 }).map((_, index) => (
                            <div 
                                key={index} 
                                className={`relative border-2 border-white rounded-full ${index !== 0 ? "-ml-4" : ""}`}
                                >
                    ...
                    <div className="flex flex-col gap-y-1 justify-center">
                        ...
                        <p className="text-sm text-black opacity-45 dark:text-white/90">from 5,000+ <span className="font-bold underline">reviews</span></p>
                    </div>
                </div>
            </article>

           <aside className="flex justify-center items-center h-full">
                <div className="flex items-center px-8 py-10 bg-white bg-opacity-25 border border-white border-opacity-60 rounded-3xl w-[80%]">
