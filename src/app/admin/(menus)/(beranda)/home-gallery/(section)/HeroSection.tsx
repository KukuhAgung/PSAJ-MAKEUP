    ...
    <section className="grid min-h-[90vh] w-full grid-cols-2 items-center rounded-xl bg-gradient-to-br from-primary-200 via-primary-50 to-primary-25 p-10">
      <article className="flex flex-col gap-y-8">
        ...
        <p className="w-[534px] text-justify font-jakarta text-base font-medium text-black opacity-45 dark:text-white/90">
          Galeri foto hasil make up dengan berbagai kategori produk make up agar
          dapat lebih meyakinkan anda untuk melibatkan kami dalam berbagai momen
          penting.
        </p>
        ...
        <div className="flex w-[80%] items-center rounded-3xl border border-white border-opacity-60 bg-white bg-opacity-25 px-8 py-10 relative">
          <div className="relative flex w-fit rounded-xl px-8 py-10">
            ...
            <Image
              priority
              alt="hero-img"
              src={imagePreview || "/images/grid-image/gallery-hero.png"}
              width={490}
              height={490}
